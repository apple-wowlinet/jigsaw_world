...
const catalogue: CatalogueCategory[] = [
  ...
  { id: 'fantasy', name: 'Fantasy', slug: 'fantasy', description: 'Dreamlike castles, magic, and imaginative worlds.', image_url: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=1200&h=900&fit=crop', icon: 'sparkles', color: '#a855f7', dark_color: '#581c87', puzzle_count: 52, group: 'Fantasy', popular: true },
